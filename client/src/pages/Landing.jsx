...
import { Leaf, Shield, Award, Sparkles, ArrowRight, Smartphone, Laptop, Battery, Cpu, Tv } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-slate-950 text-slate-100">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="font-display text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Turn Your E-Waste Into <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">Green Rewards</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Link
                to="/register"
                className="flex items-center justify-center gap-2 rounded-xl bg-emerald-500 px-6 py-3.5 text-sm font-bold text-slate-950 hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/20"
              >
                Start Recycling Now
              ...
              <Link
                to="/awareness"
                className="flex items-center justify-center gap-2 rounded-xl border border-slate-800 bg-slate-900/60 px-6 py-3.5 text-sm font-bold hover:bg-slate-800 transition-all"
              >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="animate-float relative w-full max-w-[380px] rounded-3xl border border-slate-800 bg-slate-900/40 p-6 shadow-2xl backdrop-blur-md">
      ...
      <section className="relative z-10 border-t border-slate-900 bg-slate-950/60 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-900 bg-slate-900/25 p-6 hover:border-emerald-500/20 transition-all group">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-400 group-hover:scale-110 transition-transform">
            ...
            <div className="rounded-2xl border border-slate-900 bg-slate-900/25 p-6 hover:border-emerald-500/20 transition-all group">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-teal-500/10 text-teal-400 group-hover:scale-110 transition-transform">
            ...
            <div className="rounded-2xl border border-slate-900 bg-slate-900/25 p-6 hover:border-emerald-500/20 transition-all group">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500/10 text-amber-400 group-hover:scale-110 transition-transform">
      ...
      <section className="relative z-10 py-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-800 bg-slate-900/40 p-8 md:p-12 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {categories.map((c) => {
                const Icon = c.icon;
                return (
                  <div key={c.name} className="flex items-center gap-4 rounded-2xl bg-slate-950/40 p-4 border border-slate-900 hover:border-slate-800 transition-colors">
